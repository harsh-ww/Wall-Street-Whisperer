...
def mocked_requests_get(*args, **kwargs):
    ...
    # Mock responses
    if (
        kwargs["params"]["function"] == "SYMBOL_SEARCH"
        and kwargs["params"]["keywords"] == "Tesco"
    ):
        return MockResponse(
            {
                "bestMatches": [
        ...
        kwargs["params"]["function"] == "GLOBAL_QUOTE"
        and kwargs["params"]["symbol"] == "IBM"
    ):
        return MockResponse(
            {
                "Global Quote": {
                    ...
                    "08. previous close": "185.0300",
                    "09. change": "3.1700",
                    "10. change percent": "1.7132%",
                }
            },
            200,
        )
