...
class TestGetCompanyDetailsDb:
    ...
    def insert(self):
        ...
        with conn.cursor() as cur:
            cur.execute(
                "INSERT INTO company (CompanyName, CurrentScore, CommonName, TickerCode, Exchange) VALUES (%s, %s, %s, %s, %s)",
                ("Tesco PLC", 100.5, "Tesco", "TSCO.LON", "United Kingdom"),
            )
            conn.commit()
        conn.close()
    ...
    def test_get_company_details_db_valid(self, clear_data):
        ...
        assert result == {"tracked": True, "score": 100.5, "name": "Tesco PLC"}
...
class TestSearchCompanyDB:
    ...
    def insert(self):
        ...
        with conn.cursor() as cur:
            ...
            cur.execute(
                "INSERT INTO company (CompanyName, CurrentScore, CommonName, TickerCode, Exchange) VALUES (%s, %s, %s, %s, %s)",
                ("Amazon.com Inc", 100.5, "Amazon", "AMZN", "NASDAQ"),
            )
